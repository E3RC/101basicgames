(function(){
  ...
  GameImplementations[slug]=async function(engine){
    engine.start('Nim');
    engine.setInstructions('Classic Nim. Three piles: 3, 5, and 7 objects. Players take turns removing any number of objects from a single pile. The player who takes the LAST object WINS. Computer uses optimal XOR strategy.');
